...
int main() {
    ...
    cout << mul(1.1f, 2.2f) << endl;
    cout << mul(2, 3);
	return 0;
}
// the compiler interprets numbers double when there are commas, and cannot decide which function to use
// So I have to indicate type with f.
